...
public class FileUserService implements UserService {
   private final UserRepository fileUserRepo = new FileUserRepository();
    ...
    public User create(String username, String email, String password) {
        ...
        fileUserRepo.save(user);
        return user;
    }

    @Override
    public User findById(UUID id) {
        User user = fileUserRepo.findById(id);
        if(user == null){
    ...
    public List<User> findAll() {
        List<User> userList = fileUserRepo.findAll();
