...
public class MessageController {
    ...
    public ResponseEntity<MessageResponse> update(@RequestBody MessageUpdateRequest messageUpdateRequest){
        MessageResponse messageResponse = messageService.update(messageUpdateRequest);
